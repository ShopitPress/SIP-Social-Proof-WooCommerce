	...
	<form method="post" action="options.php">
	  ...
	  <?php $options = get_option('sip-rswc-affiliate-radio'); ?>
			...
			<div id="spc-spwc-diplay-affiliate-toggle">
				...
				<label><input id="spc-spwc-affiliate-link" 	type="radio" name="sip-rswc-affiliate-radio[option_three]" value="value2"<?php checked( 'value2' == $options['option_three'] ); ?> /> Add my affiliate link</label><br />
